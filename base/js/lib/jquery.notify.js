/*
 * # Simple-Yet-Fully-Customizable-jQuery-Notification-Plugin-notify
 * https://www.jqueryscript.net/demo/Simple-Yet-Fully-Customizable-jQuery-Notification-Plugin-notify/
 *
...
Notify.prototype._show = function () {
  ...
  that.item.appendTo(that.wrapper).fadeIn(that.opt.showTime, this._afterOpen.bind(this));
};
...
Notify.prototype._unscheduleClose = function () {
  // TODO: CHAge to unschedule
  'use strict';
